/*************************************************************/
/*	glBase.cpp: OpenGL basecode that provides window handling  */
/*  and callbacks, among other things						 */
/*  Jeff Molofee											 */
/*	2001													 */
/*  modified by Aaron E. Wegner								 */
/*	July 2009												 */
/*************************************************************/
/***********************************************
*                                              *
...
BOOL CreateWindowGL (GL_Window* window)									// This Code Creates Our OpenGL Window
{
	...
	{
		//Don't switch resolution if running full screen
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	window.init.title			= "Hyper-War";							// Window Title
	...
	while (g_isProgramLooping)											// Loop Until WM_QUIT Is Received
	{
		...
		if (CreateWindowGL (&window) == TRUE)							// Was Window Creation Successful?
		{
			...
			hyperWarGame.Deinitialize ();											// User Defined DeInitialization
